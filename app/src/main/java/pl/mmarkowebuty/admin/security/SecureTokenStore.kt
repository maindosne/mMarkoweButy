package pl.mmarkowebuty.admin.security
...
class SecureTokenStore(context: Context) {
    private val prefs = context.getSharedPreferences("secure_admin_session", Context.MODE_PRIVATE)
    private val alias = "mmarkowebuty_admin_aes"
    ...
    fun read(): String? {
        ...
        val encrypted = prefs.getString("token_cipher", null) ?: return null
        return runCatching {
            val cipher = Cipher.getInstance("AES/GCM/NoPadding")
            cipher.init(
                Cipher.DECRYPT_MODE,
